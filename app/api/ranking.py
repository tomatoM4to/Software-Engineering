...
async def read_breakout_rank(
    ...
    return {
        ...
        "summary": {
            ...
            "breakout_strong": len([r for r in results if r['breakout_category'] == 'BREAKOUT_STRONG']),
            "breakout_normal": len([r for r in results if r['breakout_category'] == 'BREAKOUT_NORMAL']),
